...
export const advisorStates: Record<AdvisorStep, CustomerAdvisorState> = {
  ...
  configuration: {
    ...
    budgetEstimate: {
      ...
      totalMin: 900000,
      totalMax: 1100000,
      customerMatchSummary: "当前方案基本覆盖预算范围，酒店档期、晚宴菜单和物料周期需由顾问确认。",
      assumptions: ["120 人", "吉隆坡", "会议 + 晚宴", "含基础会务物料"],
      exclusions: ["酒店最终报价", "合同条款", "加急制作费用"],
      requiresHumanConfirmation: ["酒店档期", "晚宴菜单", "付款与合同条款"],
    },
    nextActions: [
  ...
  submit: {
    ...
    budgetEstimate: {
      ...
      totalMin: 900000,
      totalMax: 1100000,
      customerMatchSummary: "方案已整理为顾问可跟进摘要，正式报价、档期和合同条款需人工确认。",
      assumptions: ["120 人", "吉隆坡", "标准型", "含会议、晚宴、住宿、交通与物料"],
      exclusions: ["酒店最终报价", "真实供应商合同", "未确认客户特殊需求"],
